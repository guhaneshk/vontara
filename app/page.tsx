    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-900 to-teal-900 relative overflow-hidden">
      ...
      <section className="relative z-10 py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            <div className="inline-flex items-center px-6 py-3 glass rounded-full text-white text-sm font-medium mb-8 animate-float">
          ...
          <h1 className="text-7xl md:text-8xl font-black mb-8 leading-tight">
            ...
            <span className="block text-white/90 mt-4">The Smart Way</span>
          </h1>
          ...
          {/* Updated Stats */}
          <div className="flex items-center justify-center space-x-12 text-white/70">
            <div className="flex items-center space-x-3">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full border-2 border-white shadow-lg animate-float"
      ...
      <section className="relative z-10 py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold text-white mb-6 text-glow">Why Choose Vontara?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <FloatingCard key={index} className="h-full">
                <div className="glass rounded-3xl p-8 text-center h-full flex flex-col group hover:scale-105 transition-all duration-500">
                  <div
                    className={`w-20 h-20 bg-gradient-to-r ${feature.gradient} rounded-3xl flex items-center justify-center mx-auto mb-8 animate-pulse-glow group-hover:animate-bounce`}
                  >
                  ...
                  <p className="text-white/80 leading-relaxed text-lg flex-grow">{feature.description}</p>
                </div>
              </FloatingCard>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <FloatingCard>
            <div className="glass rounded-3xl p-16 text-center">
              <div className="w-24 h-24 bg-gradient-to-r from-green-600 to-emerald-600 rounded-3xl flex items-center justify-center mx-auto mb-8 animate-pulse-glow">
                <Play className="h-12 w-12 text-white" />
              </div>
              <h3 className="text-3xl font-bold text-white mb-6">More Stories Coming Soon</h3>
